...
export WARM_UP=520
export WANDB_NOTE="512,sd15,lr=1e-03,step5200+200ep,warmup520,bs32,fp32,rank32,fishing"
export OUTPUT_DIR="./output/sarlora/512_fp32_s5200+200ep_wp520_bs32_lr1e-03_rank32_fishing"

...
export WANDB_NOTE="256,sd15,lr=1e-03,step20000+100e,bs32,fp32,rank${LORA_RANK}"
export MODEL_NAME="runwayml/stable-diffusion-v1-5"
export OUTPUT_DIR="./output/sarlora/256/256_fp32_s20000+100e_wp0_bs32_lr1e-03_rank${LORA_RANK}"

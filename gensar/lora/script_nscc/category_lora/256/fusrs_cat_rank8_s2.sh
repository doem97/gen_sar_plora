...
export WARM_UP=520
export WANDB_NOTE="512,sd15,lr=1e-03,step5200+200ep,warmup520,bs32,fp32,rank8,fishing"
export OUTPUT_DIR="./output/sarlora/512_fp32_s5200+200ep_wp520_bs32_lr1e-03_rank8_fishing"
...
export WARM_UP=200
export WANDB_NOTE="512,sd15,lr=1e-03,step2000+200ep,warmup200,bs32,fp32,rank8,tanker"
export OUTPUT_DIR="./output/sarlora/512_fp32_s2000+200ep_wp200_bs32_lr1e-03_rank8_tanker"

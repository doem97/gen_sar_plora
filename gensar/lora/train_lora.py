...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="debug",
        required=True,
        help="The project being used for wandb, accelerator init.",
    )
    parser.add_argument(
        "--wandb_note",
        type=str,
        default="debug",
        required=False,
        help="The project note used for wandb.",
    )
    parser.add_argument(
        "--revision",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Rank for hidden LoRA decomposition.",
    )
...
def main():
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers(
            args.project_name,
            config=vars(args),
            init_kwargs={"wandb": {"notes": args.wandb_note}},
        )

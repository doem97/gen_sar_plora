...
export WANDB_NOTE="512x512,stable-diffusion-v1-5,lr=1e-04,100ep,mix_fp16,add keywords for shiprs/dotars"
export MODEL_NAME="runwayml/stable-diffusion-v1-5"
export CACHE_DIR="./data/cache"
export TRAIN_DATA_DIR="./data/dosrs_v1/dosrs"

export OUTPUT_DIR="./output/DOSRS_v1/dosrsv2_512_sd15_lr1e-04"

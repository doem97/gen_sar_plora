...
export WARM_UP=160
export WANDB_NOTE="512,sd15,lr=1e-03,step1600+200ep,warmup160,bs32,fp32,rank8,dredger"
export OUTPUT_DIR="./output/sarlora/512_fp32_s1600+200ep_wp160_bs32_lr1e-03_rank8_dredger"

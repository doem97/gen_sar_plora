...
class FUSAR(CustomDataset):
    ...
    IMG_EXTENSIONS = ('.tiff')
    CLASSES = [
        "Cargo", "DiveVessel", "Dredger", "Fishing", "HighSpeedCraft", "LawEnforce", "Other", "Passenger", "PortTender", "Reserved", "SAR", "Tanker", "Tug", "Unspecified", "WingInGrnd"
    ]
